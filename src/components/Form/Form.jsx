...
const Form = (props) => {
    const { handleSubmit, onChange } = props;
    const { setcategory, setdifficulty, settype } = useContext(quizContext);
    ...
    return (
        <>
            <form className='mt-2' onSubmit={handleSubmit}>
                ...
                <div className="mb-3">
                    <label htmlFor="category" className="form-label">Select Category:</label>
                    <select name='category' className="form-select" aria-label="Default select example" onChange={handleCategoryChange}>
                        <option value={'any'} defaultValue>Any Category</option>
                        {getOptionsValue(quizData.category)}
                    </select>
                </div>
                ...
                <div className="mb-3">
                    <label htmlFor="difficulty" className="form-label">Select Difficulty:</label>
                    <select name='difficulty' className="form-select" aria-label="Default select example" onChange={handleDifficultyChange}>
                        <option value={'any'} defaultValue>Any Difficulty</option>
                        {getOptionsValue(quizData.difficulty)}
                    </select>
                </div>
                ...
                <div className="mb-3">
                    <label htmlFor="type" className="form-label">Select Type:</label>
                    <select name='type' className="form-select" aria-label="Default select example" onChange={handleTypeChange}>
                        <option value={'any'} defaultValue>Any Type</option>
                        {getOptionsValue(quizData.type)}
                    </select>
                </div>
